...
<table class="cadastrados-lista">
        ...
        <tbody>
            ...
            $sql = "SELECT codigo, nome, marca, modelo, observacao, valor_compra, valor_venda, lucro, iva, volume, observacao FROM produtos";
            if (!empty($search)) {
            ...
            if ($resultado_cadastrados) {
                while ($row_cadastrados = mysqli_fetch_assoc($resultado_cadastrados)) {
                    ...
                    $hora = $row_cadastrados['valor_compra'];
                    $totalSelecionados = $row_cadastrados['valor_venda'];
                    $lucro = $row_cadastrados['lucro'];
                    $iva = $row_cadastrados['iva'];
