...
?>
    ...
    <form action="Dados-Vendas.php" method="post">
      <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<label for="data">Data: </label>
        ...
        <input type="text" id="opcoes" name="opcoes"  value="<?php echo htmlspecialchars($usuario); ?>" readonly></p>
      <p>
...
$query_cli = "SELECT nome FROM usuarios";
$resultado_cli = mysqli_query($mysqli, $query_cli);
...
?>
      ...
      <div style="background-color:orange; padding:0; width:100%; height:10vh;"><h2 style="color: white; font-size:20px; text-align: center; margin-left:25%;" >Pagamento De Salarios</h2></div>

      <form action="salarios.php" method="post">

      <h2 style="color: black; font-size:20px; margin-left:3%; margin-top:15%;" >Funcionarios &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;  Bonus</h2>
      <select name="nome" id="nome" style="height: 7vh; width:40%; margin-top:12%; margin-left:7%; font-size:16px;">
        <?php
    ...
    <input type="text" name="bonus" id="bonus" placeholder="0.00" style="height: 7vh; width:20%; position:relative;top:40%; left:12%; font-size:16px;">
        

    <h2 style="color: black; font-size:20px; margin-left:3%; margin-top:32%;" >Metodo de pagamento &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;  Tel./NIB</h2>

    <select id="metodo" name="metodo" style=" width: 40%; height: 7vh; margin-top: 55px;  margin-left:7%;">
          <option value="Cash">CASH</option>
          <option value="visa">VISA</option>
          <option value="e-mola">E-MOLA</option>
          <option value="m-pesa">M-PESA</option>
        ...
        <input type="text" name="conta" id="conta" placeholder="(+258)/0001" style="height: 7vh; width:20%; position:relative; top:50%; left:12%; font-size:16px;"><br>

        <h2 style="color: black; font-size:20px; margin-left:3%; margin-top:49%;" >Salario</h2>
        <input type="text" name="salario" id="salario" placeholder="0.00" style="height: 7vh; width:20%; margin-top:9%; margin-left:9%; font-size:16px;">

        <button type="submit" name="submit" id="submit"  style="color:white; height: 7vh; width:43%; margin-top:9%; margin-left:7%; border:none; border-radius:5px; background-color: rgb(84, 248, 84); font-size:16px;"> CONFIRMAR </button>
        </form>
      </div>
...
document.getElementById("toggle-form-servico").disabled = true;
document.getElementById("toggle-form-servico").style.backgroundColor = "gray";
document.getElementById("toggle-form-financa").disabled = true;
document.getElementById("toggle-form-financa").style.backgroundColor = "gray";
